...
#[cfg(all(feature = "protocol-ws", not(all(target_arch = "wasm32", not(target_os = "wasi")))))]
#[cfg_attr(docsrs, doc(cfg(all(feature = "protocol-ws", not(all(target_arch = "wasm32", target_os = "wasi"))))))]
...
#[cfg(all(feature = "protocol-ws", all(target_arch = "wasm32", not(target_os = "wasi"))))]
#[cfg_attr(docsrs, doc(cfg(all(feature = "protocol-ws", all(target_arch = "wasm32", not(target_os = "wasi"))))))]
